...
public class FraudDetection {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= n; i++) {
            ...
            String transactionId = sn.nextLine();
            System.out.print("Policy Number: ");
            String policyNumber = sn.nextLine();
            System.out.print("Amount: ");
            double amount = Double.parseDouble(sn.nextLine());
            System.out.print("Transaction Date: ");
            String transactionDate = sn.nextLine();
            System.out.print("Is Fraudulent (true/false): ");
            boolean isFraudulent = Boolean.parseBoolean(sn.nextLine());
